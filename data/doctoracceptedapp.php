...
if ($errorr || $Nrow==0){
	if ($errorr) {
        ...
        echo "No Appointments accpted yet";
...
<td>
<form action='../data/viewpatientd.php' method=POST><input type='text' name='did' hidden value='$rid'> <input type='submit' style='width:100%;background-color:green' value='Open'></form>
</td>
    <td>
